...
public class Motorista {
    ...
    public static class MotoristaBuilder {
        ...
        public MotoristaBuilder withIdade(int idade) {
            if (idade < 0)
                throw new IllegalArgumentException("idade não deve ser negativo");
            this.idade = idade;
            return this;
        }
        ...
        public MotoristaBuilder withPontos(int pontos) {
            if (pontos < 0)
                throw new IllegalArgumentException("pontos não deve ser negativo");
            this.pontos = pontos;
            return this;
        }
        ...
        private void validarExcecoes(){
            if (nome == null || habilitacao == null)
                throw new NullPointerException("nome e habilitacão não devem ser nulos");
        }
    }
}
